...
1. Get the Level sets Pickle file using the c_uniform_sampling.py code from cuniform_trajectory_sampling folder or download the pickle file from [level sets](https://drive.google.com/drive/folders/1KnRhqOXw7AnvsciyZiXCbPs3dhcaYhow?usp=sharing)
