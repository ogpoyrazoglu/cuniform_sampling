...
with open("/home/isleri/mahes092/C_Uniform/Datasets/x_u_pair_na3_ni30_max_flow_probability.pkl", "rb") as f:
    data = pickle.load(f)
model = torch.load("/home/isleri/mahes092/C_Uniform/Random_Walk_Uniformity/Models/NN_Random_Walk_All/single_probability_model_best.pt").cuda()
model.eval()
...
for each_level_set_bin in range(1, len(bins_level_set)):
...
bar_width = 0.4
x = np.arange(1, len(bins_level_set))
